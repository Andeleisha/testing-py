...
app = Flask(__name__)
app.secret_key = "SECrreRETSECRETSECRET"
...
def is_mel(name, email):
    """Is this user Mel?
		...
		False
		>>> is_mel("Mel Melitpolski", "jhgjhgj@gmail.com")
		True
		>>> is_mel("yhfghgfh", "mel@ubermelon.com")
		True
    ...
    return name2 == "mel melitpolski" or name2 == "mel" or name2 == "melitpolski" or email2 == "mel@ubermelon.com"
